...
describe('Describe Cases', () => {
  ...
  tree.left = new TreeNode(4, null, null);
  tree.right = new TreeNode(8, null, null);
  tree.left.left = new TreeNode(11, null, null);
  tree.right.left = new TreeNode(13, null, null);
  tree.right.right = new TreeNode(4, null, null);
  tree.left.left.left = new TreeNode(7, null, null);
  tree.left.left.right = new TreeNode(2, null, null);
  tree.right.right.left = new TreeNode(1, null, null);
